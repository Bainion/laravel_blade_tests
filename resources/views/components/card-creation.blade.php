<div class="w-full h-fit max-w-xs overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg shadow-slate-950/5">
    <img class="m-1.5 w-[calc(100%-12px)] rounded-[5px]" src="https://images.unsplash.com/photo-1581337204873-ef36aa186caa?q=80&w=800&auto=format&fit=crop" alt="image" />
    <div class="w-full rounded px-3 py-2">
    ...
    <div class="w-full flex justify-end rounded px-3 pb-3 pt-1.5">
